...
| [04-test-data.md](04-test-data.md) | Inputs estáticos, constantes e builders; estrutura test-data/e2e e por fluxo |
| [05-lib.md](05-lib.md) | lib/env.ts, lib/data-factory.ts e lib/Utils.ts (getDeviceFromCapabilities, seletores app, reLaunchApp) |
